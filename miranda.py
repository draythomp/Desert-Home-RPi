...
# Note, I changed a couple of lines down in sendSoap to have a timeout 
# and to report the error.  You can find them by searching for 'dave' 
...
def msearch(argc,argv,hp):
	...
	myip = ''
	lport = hp.port
	#print "argc", argc #dave added this for debugging
	#print "argv", argv
